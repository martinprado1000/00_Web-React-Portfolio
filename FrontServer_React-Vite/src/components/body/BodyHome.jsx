...
import {
  ...
  FaPhone,
  FaLinkedin,
  FaNodeJs, FaReact, FaDatabase, FaBootstrap, FaGit
} from "react-icons/fa";
  ...
  return (
    <Container fluid>
      <Row>
        <Col xs={9} style={{ padding: "20px" }}>
          ...
          <div className="mt-4">
            ...
            <p>
              Soy un entusiasta del desarrollo de aplicaciones con una firme
              determinación de adquirir constantemente nuevos conocimientos y
              habilidades en el área. Mi compromiso con el aprendizaje continuo
              se combina con la predisposición al trabajo en equipo y a
              contribuir positivamente en cualquier proyecto en el que esté
              involucrado. Estoy ansioso por formar parte de equipos dinámicos
        ...
        <div className="row g-0">
          <div className="col-md-3 d-flex justify-content-center align-items-center">
            <img src="Toolsoft.PNG" className="card-img" alt="Imagen de Toolsoft SRL" />
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                infraestructura. Windows, Linux, VMWare, CCTV, telefonía analógica e IP, networking, Mikrotik. Encargado del análisis,
                desarrollo e implementación de proyectos de infraestructura. Leer
                manuales técnicos, consultar con los usuarios o realizar
      ...
      <div className="card mb-3">
        <div className="row g-0">
          <div className="col-md-3 d-flex justify-content-center align-items-center">
            <img src="w.PNG" className="card-img mx-5" alt="Imagen de Wisetek SRL" />
          </div>
          <div className="col-md-8">
            <div className="card-body">
      ...
      <div className="card mb-3">
        <div className="row g-0">
          <div className="col-md-3 d-flex justify-content-center align-items-center">
            <img src="IBM.PNG" className="card-img card-center" alt="Imagen de IBM Argentina" />
          </div>
          <div className="col-md-8">
            <div className="card-body">
